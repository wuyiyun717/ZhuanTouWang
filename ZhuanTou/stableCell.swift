...
class stableCell: UITableViewCell{
    ...
    func addBenefit(int: Int!){
        ...
        self.benefit.frame = CGRectMake(0, 50, self.bigView.frame.width/3, 20)
        ...
        self.benefitTitle.frame = CGRectMake(0, 70, self.bigView.frame.width/3, 20)
        self.benefitTitle.text = "固定收益"
        ...
        self.divideLine.frame = CGRectMake(self.bigView.frame.width/3, 50, 1, 40)
    ...
    func addPeriod(int: Int!){
        self.period = UILabel()
        self.period.frame = CGRectMake(self.bigView.frame.width/3, 50, self.bigView.frame.width/3, 20)
        ...
        self.periodTitle.frame = CGRectMake(self.bigView.frame.width/3, 70, self.bigView.frame.width/3, 20)
        ...
        self.divideLine2.frame = CGRectMake(self.bigView.frame.width/3*2, 50, 1, 40)
        self.bigView.addSubview(self.divideLine2)
    }
    
    func addPercent(int:Int!){
        var percent = KDGoalBar(frame: CGRectMake(self.bigView.frame.width/3*2 + (self.bigView.frame.width/3 - 50)/2, 40, 50, 50))
